...
Recent Projects: <br>
Helped develop IK for the procedurally generated walking algorithm on Cujaw in C++ and using Unity for simulation.
[![Battlebots Youtube Link](https://img.youtube.com/vi/VIEKJpJmX7M/0.jpg))](https://youtu.be/VIEKJpJmX7M) <b>



https://github.com/Superliminal-Defenestration/Multiscope
Simple oscilloscope project running on STM32F405. Mostly practice developing firmware that drives USB directly from the MCU instead of through a converter chip.
